...
extern void lib3ds_matrix_trasnform ( Lib3dsMatrix M, float *x, float *y, float *z );
extern void lib3ds_matrix_create ( Lib3dsMatrix M ,float tx, float ty, float tz ,float sx, float sy, float sz ,float rx, float ry, float rz );
